...
function myFunction() {
//    document.getElementById("category1").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category2").innerHTML = "<p><strong>Question 2:</strong> \n\
//The correct answer is <strong>Answer 2</strong>.</p>";
//    document.getElementById("category3").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category4").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category5").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category6").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category7").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category8").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category9").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category10").innerHTML = "<p><strong>Question 1:</strong> \n\
//The correct answer is the <strong>Answer 1</strong>.</p>";
//    document.getElementById("category11").innerHTML = "<p>You answered them all right!</p>";
